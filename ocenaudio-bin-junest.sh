...
case "$1" in
	'') $HERE/.local/share/junest/bin/junest proot -n -b "--bind=/home --bind=/home/$(echo $USER) --bind=/media --bind=/mnt --bind=/opt --bind=/usr/lib/locale --bind=/etc/fonts --bind=/usr/share/fonts --bind=/usr/share/fontconfig" 2> /dev/null -- /usr/share/ocenaudio/bin/ocenaudio "$@";;
	*) $HERE/.local/share/junest/bin/junest proot -n -b "--bind=/home --bind=/home/$(echo $USER) --bind=/media --bind=/mnt --bind=/opt --bind=/usr/lib/locale --bind=/etc/fonts --bind=/usr/share/fonts--bind=/usr/share/fontconfig" 2> /dev/null -- /usr/share/ocenaudio/bin/ocenvst "$@";;
esac
EOF
...
mv ./$APP.AppDir/.junest/opt/ocenaudio ./$APP.AppDir/.junest/usr/share/ocenaudio
...
rm -R -f ./$APP.AppDir/.junest/usr/share/glib-2.0
...
rm -R -f ./$APP.AppDir/.junest/usr/share/libinput
rm -R -f ./$APP.AppDir/.junest/usr/share/libwacom
...
rm -R -f ./$APP.AppDir/.junest/usr/share/qt
...
rm -R -f ./$APP.AppDir/.junest/usr/lib/jack
...
mv ./*AppImage ./ocenaudio-junest-"$VERSION""$VERSIONAUR"-x86_64.AppImage
